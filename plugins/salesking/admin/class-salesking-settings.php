...
class Salesking_Settings {
	...
	public function register_all_settings() {
		...
		if (defined('B2BKING_DIR')){
			register_setting('salesking', 'salesking_enable_offers_setting');
			add_settings_field('salesking_enable_offers_setting', esc_html__('Enable Offers', 'salesking'), array($this,'salesking_enable_offers_setting_content'), 'salesking', 'salesking_main_settings_section_modules');
		}
		...
		// ---- Commission Calculation Base (global) ----
register_setting('salesking', 'salesking_commission_calc_after_discounts');
add_settings_field(
    'salesking_commission_calc_after_discounts',
    esc_html__('Apply after discounts', 'salesking'),
    array($this, 'salesking_commission_calc_after_discounts_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);

register_setting('salesking', 'salesking_commission_calc_include_product_taxes');
add_settings_field(
    'salesking_commission_calc_include_product_taxes',
    esc_html__('Include product taxes (VAT)', 'salesking'),
    array($this, 'salesking_commission_calc_include_product_taxes_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);

register_setting('salesking', 'salesking_commission_calc_include_shipping');
add_settings_field(
    'salesking_commission_calc_include_shipping',
    esc_html__('Include shipping amount', 'salesking'),
    array($this, 'salesking_commission_calc_include_shipping_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);

register_setting('salesking', 'salesking_commission_calc_include_shipping_taxes');
add_settings_field(
    'salesking_commission_calc_include_shipping_taxes',
    esc_html__('Include shipping taxes', 'salesking'),
    array($this, 'salesking_commission_calc_include_shipping_taxes_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);

register_setting('salesking', 'salesking_commission_calc_include_fees');
add_settings_field(
    'salesking_commission_calc_include_fees',
    esc_html__('Include fees', 'salesking'),
    array($this, 'salesking_commission_calc_include_fees_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);

register_setting('salesking', 'salesking_commission_calc_include_fee_taxes');
add_settings_field(
    'salesking_commission_calc_include_fee_taxes',
    esc_html__('Include fee taxes', 'salesking'),
    array($this, 'salesking_commission_calc_include_fee_taxes_content'),
    'salesking',
    'salesking_main_settings_section_commission'
);


		do_action('salesking_register_settings');

	}


	function salesking_commission_calc_after_discounts_content(){
    $val = get_option('salesking_commission_calc_after_discounts', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_after_discounts" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Use item totals after coupons/discounts. If off, use subtotals (before discounts).','salesking').'</label>
    </div>';
}

function salesking_commission_calc_include_product_taxes_content(){
    $val = get_option('salesking_commission_calc_include_product_taxes', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_include_product_taxes" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Add item tax amounts to the commission base.','salesking').'</label>
    </div>';
}

function salesking_commission_calc_include_shipping_content(){
    $val = get_option('salesking_commission_calc_include_shipping', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_include_shipping" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Add shipping total (without tax).','salesking').'</label>
    </div>';
}

function salesking_commission_calc_include_shipping_taxes_content(){
    $val = get_option('salesking_commission_calc_include_shipping_taxes', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_include_shipping_taxes" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Add shipping tax amounts as well.','salesking').'</label>
    </div>';
}

function salesking_commission_calc_include_fees_content(){
    $val = get_option('salesking_commission_calc_include_fees', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_include_fees" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Add order fee totals (without tax).','salesking').'</label>
    </div>';
}

function salesking_commission_calc_include_fee_taxes_content(){
    $val = get_option('salesking_commission_calc_include_fee_taxes', 'no');
    echo '
    <div class="ui toggle checkbox">
      <input type="checkbox" name="salesking_commission_calc_include_fee_taxes" value="yes" '.checked($val, 'yes', false).'>
      <label>'.esc_html__('Add taxes of fees.','salesking').'</label>
    </div>';
}
	...
	function salesking_tables_language_option_setting_content(){
		...
		<div class="ui fluid search selection dropdown salesking_tables_language_option_setting">
		  ...
		  <div class="item" data-value="Persian"><i class="ir flag"></i>Persian</div>
	...
	function salesking_enable_custom_payouts_setting_content(){
		...
		<div id="salesking_custom_method_container">
			<input type="text" name="salesking_enable_custom_payouts_title_setting" value="'.esc_html(get_option( 'salesking_enable_custom_payouts_title_setting', '' )).'" placeholder="'.esc_html__('Enter method title here...','salesking').'" id="salesking_custom_method_title"><br >
	...
	function salesking_enable_offers_setting_content(){
		echo '
		<div class="ui toggle checkbox">
		  <input type="checkbox" name="salesking_enable_offers_setting" value="1" '.checked(1,get_option( 'salesking_enable_offers_setting', 1 ), false).'">
		  <label></label>
		</div>
		';
	}
		...
		<form id="salesking_admin_form" method="POST" action="options.php">
			...
			<div id="salesking_admin_wrapper" >
				...
				<div id="salesking_admin_menu" class="ui labeled stackable large vertical menu attached">
					<img id="salesking_menu_logo" src="<?php 
				...
				<div id="salesking_tabs_wrapper">
					...
					<?php
						...
						do_action('salesking_settings_panel_end_items_tabs');
	...
	function mask_email($email) {
	    ...
	    // Mask the local part, show only first and last character
	    $masked_local_part = substr($local_part, 0, 1) . str_repeat('*', strlen($local_part) - 2) . substr($local_part, -1);
