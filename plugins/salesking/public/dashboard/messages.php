                        ...
                        <div class="nk-reply-form-group">
                            <div class="nk-reply-form-input-group">
                                <div class="nk-reply-form-input nk-reply-form-input-to">
                                    <label class="label" style="width: 50px;"><?php esc_html_e('Message to: ', 'salesking'); ?></label>
                                    <select name="salesking_dashboard_recipient" id="salesking_dashboard_recipient">
                                        <optgroup label="<?php esc_html_e('Support Team', 'salesking'); ?>">
                                            <option value="shop"><?php esc_html_e('Support Team','salesking'); ?></option>
                                        </optgroup>
                                        <?php
