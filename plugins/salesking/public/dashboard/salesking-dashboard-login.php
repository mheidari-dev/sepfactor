...
<html>
    <head>
        ...
        if (empty($favicon_setting)){
            $favicon_setting = plugins_url('../../includes/assets/images/salesking-icon2.png', __FILE__);
        }
